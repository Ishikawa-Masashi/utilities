 ...
 * determine the match.
 * https://github.com/microsoft/fluentui/blob/master/packages/utilities/src/array.ts
 *
 * @public
...
export function toMatrix<T>(items: T[], columnCount: number): T[][] {
  return items.reduce<T[][]>((rows: T[][], currentValue: T, index: number) => {
 ...
 */
export function addElementAtIndex<T>(
  array: T[],
  index: number,
  itemToAdd: T
): T[] {
